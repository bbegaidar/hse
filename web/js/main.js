  ...
  function nextSection(event) {
    ...
    unbindScroll(visibleSection.next(".cd-section"), animationParams[3]), animating || visibleSection.is(":last-of-type") || (animating = !0, visibleSection.removeClass("visible").children("div").velocity(animationParams[1], animationParams[3], animationParams[4]).end().next(".cd-section").addClass("visible").children("div").velocity(animationParams[0], animationParams[3], animationParams[4], function () {
      ...
      if(animate_on == 0){
        ...
        $('#activity .text-wrap').addClass('fadeInLeft').removeClass('opacity0 opacity00');
        $('#activity .left-content .item-wrap').addClass('zoomIn').removeClass('opacity0 opacity00');
        $('#activity .btn-wrap').removeClass('opacity0 opacity00');
        
        $('#b1 .showcase-wrap').addClass('fadeInLeft').removeClass('opacity0 opacity00');
        $('#b1 .btn-wrap').addClass('ownSlideInUp').removeClass('opacity0 opacity00');
        $('#b2 .item').addClass('fadeInUp').removeClass('opacity0 opacity00');
        
        $('#o2 .text-wrap').addClass('fadeInLeft').removeClass('opacity0 opacity00');
        $('#o2 .left-content .item-wrap').addClass('zoomIn').removeClass('opacity0 opacity00');
        
        $('#o2 main .item-wrap').find('.btn-wrap').addClass('ownSlideInUp2');
        $('#o2 footer .footer-wrap').find('.btn-wrap').addClass('ownSlideInUp3');
         
        $('#t2 .text-wrap').addClass('fadeInLeft').removeClass('opacity0 opacity00');
        $('#t2 .left-content .item-wrap').addClass('zoomIn').removeClass('opacity0 opacity00'); 
        
        $('#t2 main .item-wrap').find('.btn-wrap').addClass('ownSlideInUp2').removeClass('opacity0 opacity00');
        $('#t2 footer .footer-wrap').find('.btn-wrap').addClass('ownSlideInUp3').removeClass('opacity0 opacity00');
        
        $('#e2 main .item-wrap').find('.number-wrap').addClass('fadeIn').removeClass('opacity0 opacity00');
        $('#e2 main .item-wrap').find('.icon-wrap').addClass('fadeIn').removeClass('opacity0 opacity00');
        $('#e2 main .item-wrap').find('.line-wrap').addClass('clipLeftToRight').removeClass('opacity0 opacity00');

        $('#e1 .showcase-wrap').addClass('fadeInLeft').removeClass('opacity0 opacity00');
      ...
      if(animate_on == 1){
        ...
        $('#b3 main .main-wrap .b3-vantage .b3-vantage__line_top .b3-vantage__arrow').addClass('ownFadeInDown').removeClass('opacity0');
        $('#b3 main .main-wrap .b3-vantage .b3-vantage__line_bottom .b3-vantage__arrow').addClass('ownFadeInUp').removeClass('opacity0');
        $('#b3 main .main-wrap .b3-vantage .b3-vantage__icon').addClass('fadeIn').removeClass('opacity0');
        $('#b3 main .btn-wrap').addClass('ownSlideInUp6');
        ...
        $('#t3 .item-wrap').find('.item-icon').addClass('fadeIn');
        $('#t3 .item-wrap').find('.item-text, .step').addClass('fadeIn');
        $('#t3 .item-wrap').find('.dotted-line').addClass('clipLeftToRight');
        ...
        $('#e3 footer').find('.btn-wrap').addClass('ownSlideInUp4');
      }
      if(animate_on == 2){
        $('#results .item').addClass('fadeInUp').removeClass('opacity0');
        $('#results .icon-wrap').removeClass('opacity00');
        
        $('#b4 .content-wrap .item').addClass('fadeInDown').removeClass('opacity0');
        $('#b4 main .btn-wrap').addClass('ownSlideInUp6');
        ...
        // $('#o4 .btn-wrap').addClass('ownSlideInUp4').removeClass('ownSlideInUp5 opacity0');
        
        $('#t4 main .item__dot').addClass('fadeIn').removeClass('opacity0');
        $('#t4 main .item__text').addClass('fadeIn').removeClass('opacity0');
        $('#t4 main .item__icon').addClass('fadeIn').removeClass('opacity0');
        $('#t4 .btn-wrap').addClass('ownSlideInUp6').removeClass('opacity0');
        
        $('#e4 main .item__dot').addClass('fadeIn').removeClass('opacity0');
        $('#e4 main .item__text').addClass('fadeIn').removeClass('opacity0');
        $('#e4 main .item__icon').addClass('fadeIn').removeClass('opacity0');
        $('#e4 .btn-wrap').addClass('ownSlideInUp6');
      }
      if(animate_on == 3){
        $('#docs .main-wrap .btn-wrap').addClass('ownSlideInUp3').removeClass('opacity0');
        setTimeout(function(){
          $('#docs .footer-wrap .btn-wrap').addClass('ownSlideInUp4').removeClass('opacity0');
        }, 750);
        $('#b5 .text-wrap').addClass('fadeInLeft').removeClass('opacity0');
        $('#b5 .left-content .item-wrap').addClass('zoomIn').removeClass('opacity0');
      }
      if(animate_on == 4){
        $('#b6 .main-wrap .btn-wrap .point-wrap').addClass('slideInLeft').removeClass('opacity0');
        $('#b6 .main-wrap .btn-wrap .btn').addClass('ownSlideInUpB6').removeClass('opacity0');
        $('#b6 main .btn-wrap').addClass('ownSlideInUp7');
      }
      if(animate_on == 5){
        $('#program .content-wrap .item').addClass('zoomIn').removeClass('opacity0');
        $('#b7 .btn-wrap .point-wrap').addClass('bounceInRight').removeClass('opacity0');
        $('#b7 .btn-wrap .btn').addClass('ownSlideInUp').removeClass('opacity0');
        $('#b7 .item-bottom__wrap').addClass('ownSlideInUpB7').removeClass('opacity0');
      }
