<main>
    ...
    <div class="c5__title">
      <h2><?= Yii::t('training','Reviews professionals')?></h2>
      <p><?= Yii::t('training','trained in our company')?></p>
    </div>
    <!-- reviews begin -->
          ...
          <div class="text-wrap">
            <div class="person-wrap">
              ...
              <div class="person-wrap__icon">
                <img class="person__icon" src="/img/training/t5/person__icon.png" alt="">
              </div>
            </div>
            <div class="reviews__text"><?= $review->content->review ?></div>
          </div>
        </div>
        <?php } ?>
      ...
      <div class="c5-social">
        <div class="c5-social__item">
          <a href="#" target="_blank">
            <img class="c5-social__img" src="/img/training/t5/inst-icon.png" alt="">
          </a>
        </div>
        <div class="c5-social__item">
          <a href="#" target="_blank">
            <img class="c5-social__img" src="/img/training/t5/face-icon.png" alt="">
          </a>
        </div>
        </div>
      <div class="c5-maint">
        <a href="https://maint.kz/" target="_blank">
          <img class="c5-maint__img" src="/img/training/t5/maint-icon.png" alt="">
        </a>
      </div>
    </footer>
  </div>
