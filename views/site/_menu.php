...
?>
    ...
    <div id="menu" class="menu cd-section2 animated slideOutUp opacity0" style="display:none;">
        <div class="bg ">
        <?php echo $this->render('main/_menu_header.php', ['pageName' => Yii::t('static','Menu')]);?>
              ...
              <?= Menu::widget([
                'items' => [
                    ...
                    [
                        ...
                        'url' => ['site/services'],
                        'template' => '<span class="menu-link services">{label}</span><div class="ray-wrap ray-wrap-hover"><div class="ray ray-hover"></div><img src="/img/menu/bg-ray.png" alt="Ray line"></div><div class="list-services">
            <ul class="d-flex">
