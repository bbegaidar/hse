<main>
    <div class="showcase-wrap animated delay-1s fadeInLeft opacity0">
  <div class="showcase-logo c1__logo">
    <img src="/img/expertise/e1/sh-logo.png" alt="">
  </div>
  <div class="sh-text">
  ...
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <div class="c1-hero__item">
        ...
        <img class="c1-hero__plashka" src="/img/expertise/e1/c1-plashka.svg" alt="">
        <img class="c1-hero__photo" src="/img/expertise/e1/c1__block-photo.png" alt="">
      </div>
    </div>
    <div class="swiper-slide">
      <div class="c1-hero__item">
        ...
        <img class="c1-hero__plashka" src="/img/expertise/e1/c1-plashka.svg" alt="">
        <img class="c1-hero__photo" src="/img/expertise/e1/c1__block-photo-2.png" alt="">
      </div>
    </div>
    <div class="swiper-slide">
      <div class="c1-hero__item">
...
<div class="c1-bottom-text">
  <p class="c1-bottom-text__top"><?= Yii::t('expertise', 'send an application')?></p>
  <p class="c1-bottom-text__bottom"><?= Yii::t('expertise', 'for calculating the cost of the safety review, <br> and we will send a commercial proposal within 60 minutes')?></p>
</div>

<div class="btn-wrap-clone"></div>
<div class="btn-wrap animated opacity0 delay-500ms">
  <a href="#" class="neon-btn neon-btn-normal neon-btn-with-icon " data-type="modal" data-target="exRequest">
    <img class="btn-icon" src="/img/btn-icons/icon-mail.png" alt="icon"> <?= Yii::t('static', 'Send request') ?></a>
</div>


<!-- bottom lines begin -->
<div class="bg-line-1">
  <img src="/img/expertise/e1/c1__line1.png" alt="Background line">
</div>
<div class="bg-line-2 d-none">
  <img src="/img/expertise/e1/c1__line2_1.png" alt="Background line">
</div>
<!-- bottom lines end -->
<!-- bottom mobile lines begin -->
<div class="bg-mob-line-1">
  <img src="/img/expertise/e1/c1-mob__line-1.png" alt="Background line">
</div>
<div class="bg-mob-line-2">
  <img src="/img/expertise/e1/c1-mob__line-2.png" alt="Background line">
</div>
