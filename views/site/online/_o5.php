<main>
  ...
  <div class="c5__title">
    <h2><?= Yii::t('online','Expert reviews,') ?></h2>
    <p><?= Yii::t('online','trained in our company') ?></p>
  </div>
  <!-- reviews begin -->
        ...
        <div class="text-wrap">
          <div class="person-wrap">
            ...
            <div class="person-wrap__icon">
              <img class="person__icon" src="/img/online/o5/person__icon.png" alt="">
            </div>
          </div>
    ...
    <div class="c5-social">
      <div class="c5-social__item">
        <a href="#" target="_blank">
          <img class="c5-social__img" src="/img/online/o5/inst-icon.png" alt="">
        </a>
      </div>
      <div class="c5-social__item">
        <a href="#" target="_blank">
          <img class="c5-social__img" src="/img/online/o5/face-icon.png" alt="">
        </a>
      </div>
      </div>
    <div class="c5-maint">
      <a href="https://maint.kz/" target="_blank">
        <img class="c5-maint__img" src="/img/online/o5/maint-icon.png" alt="">
      </a>
    </div>
  </footer>
</div>
