<main>
  ...
  <div class="b1-video">
    ...
    <div id="b1__button" class="b1-video__cover">
      <img id="b1__video-button" class="b1-video__button animated pulse-button slower infinite" src="/img/about/b1/b1__video-button.png" alt="">
    </div>
    <!-- <div id="divPlayer1" class="b1-video__item"></div> -->
    <video id="divPlayer1" type="video/mp4" class="b1-video__item" src="/img/hse.mp4" controls></video>
  </div>
  <!-- video end -->
